...
public class VehicleGenerator {
  ...
  /**
   * This constructor reads the arrival and turning probabilities
   * for different time periods from a file.
   * <p>
   * Each line of input defines the probabilities for a specific
   * period with the following contents <br>
   * <ol>
