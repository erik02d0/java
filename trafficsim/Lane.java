...
public class Lane {
  ...
  private Vehicle[] theLane; // array named theLane, containing Vehicle
    ...
    public void putLast(Vehicle v) {
        if (this.theLane[this.theLane.length-1]==null) {
            ...
            throw new RuntimeException("Lane is full!");
        }
    }

    /**
     * Demonstrates the use of the the class and its methods.
     */
    public static void main(String[] args) { 
        Lane myLane = new Lane(16);
        myLane.theLane[0] = new Vehicle('X');
        myLane.theLane[1] = new Vehicle('X');
        myLane.theLane[4] = new Vehicle('X');
        myLane.theLane[8] = new Vehicle('X');
        myLane.theLane[10] = new Vehicle('X');
        myLane.theLane[12] = new Vehicle('X');
        myLane.theLane[15] = new Vehicle('X');
